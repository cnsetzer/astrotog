...
if __name__ == "__main__":
    ...
    if rank == 0:
        ...
        seds_path = '/Users/cnsetzer/Documents/LSST/kilonova_seds/rosswog/NSNS/winds'
        ...
        run_dir = 'lsst_rossnumeric_kraken2036_' + datetime.datetime.now().strftime('%d%m%y_%H%M%S')
