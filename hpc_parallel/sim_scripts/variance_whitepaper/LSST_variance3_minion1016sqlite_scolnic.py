...
if __name__ == "__main__":
    ...
    if rank == 0:
        ...
        cadence_path = '/share/data1/csetzer/lsst_cadences/minion_1016_sqlite.db'
        cadence_ra_col = '_ra'
        ...
        run_dir = 'lsst_scolnic_minion1016sqlite_var3_' + datetime.datetime.now().strftime('%d%m%y_%H%M%S')
