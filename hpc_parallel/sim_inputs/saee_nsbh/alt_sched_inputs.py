...
transient_duration = 50.0  # in days
t_before = 40.0
t_after = 40.0
...
dither_path = '/share/data1/csetzer/lsst_cadences/descDithers_alt_sched.csv'
cadence_path = '/share/data1/csetzer/lsst_cadences/alt_sched.db'
cadence_ra_col = '_ra'
...
run_dir = 'lsst_saee_nsbh_alt_sched_' + datetime.datetime.now().strftime('%d%m%y_%H%M%S')
