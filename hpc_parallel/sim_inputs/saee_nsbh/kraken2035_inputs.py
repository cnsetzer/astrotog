...
cadence_path = '/share/data1/csetzer/lsst_cadences/kraken_2035.db'
dither_path = '/share/data1/csetzer/lsst_cadences/descDithers_kraken_2035.csv'
cadence_ra_col = '_ra'
...
run_dir = 'lsst_saee_nsbh_kraken2035_' + datetime.datetime.now().strftime('%d%m%y_%H%M%S')
