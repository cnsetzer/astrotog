...
rate = 100  # Rate in events per GPC^3 per restframe time
...
cadence_path = '/share/data1/csetzer/lsst_cadences/colossus_2664.db'
dither_path = '/share/data1/csetzer/lsst_cadences/descDithers_colossus_2664.csv'
cadence_ra_col = '_ra'
...
run_dir = 'lsst_saee_nsbh_colossus2664_' + datetime.datetime.now().strftime('%d%m%y_%H%M%S')
