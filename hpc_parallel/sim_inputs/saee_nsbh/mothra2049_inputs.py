...
cadence_path = '/share/data1/csetzer/lsst_cadences/mothra_2049.db'
dither_path = '/share/data1/csetzer/lsst_cadences/descDithers_mothra_2049.csv'
cadence_ra_col = '_ra'
...
run_dir = 'lsst_saee_nsbh_mothra2049_' + datetime.datetime.now().strftime('%d%m%y_%H%M%S')
