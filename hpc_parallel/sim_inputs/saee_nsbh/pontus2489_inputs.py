...
cadence_path = '/share/data1/csetzer/lsst_cadences/pontus_2489.db'
dither_path = '/share/data1/csetzer/lsst_cadences/descDithers_pontus_2489.csv'
cadence_ra_col = '_ra'
...
run_dir = 'lsst_saee_nsbh_pontus2489_' + datetime.datetime.now().strftime('%d%m%y_%H%M%S')
