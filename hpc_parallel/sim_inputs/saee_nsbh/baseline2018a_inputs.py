...
dither_path = '/share/data1/csetzer/lsst_cadences/descDithers_baseline2018a.csv'
...
run_dir = 'lsst_saee_nsbh_baseline2018a_' + datetime.datetime.now().strftime('%d%m%y_%H%M%S')
