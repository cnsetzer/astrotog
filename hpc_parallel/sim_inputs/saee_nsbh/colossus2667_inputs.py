...
transient_duration = 30.0  # in days used to select time before survey to begin injecting transients
t_before = 40.0
t_after = 40.0
...
rate = 200  # Rate in events per GPC^3 per restframe time
...
cadence_path = '/share/data1/csetzer/lsst_cadences/colossus_2667.db'
dither_path = '/share/data1/csetzer/lsst_cadences/descDithers_colossus_2667.csv'
cadence_ra_col = '_ra'
...
run_dir = 'lsst_saee_nsbh_colossus2667_' + datetime.datetime.now().strftime('%d%m%y_%H%M%S')
