...
cadence_path = '/share/data1/csetzer/lsst_cadences/rolling_mix_10yrs_opsim.db'
dither_path = ''
cadence_ra_col = '_ra'
...
run_dir = 'lsst_saee_nsbh_fbs_rolling_mix_' + datetime.datetime.now().strftime('%d%m%y_%H%M%S')
