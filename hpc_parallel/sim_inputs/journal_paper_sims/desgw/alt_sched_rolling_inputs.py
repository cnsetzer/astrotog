...
# ----------------------------------------------------------------------
debug = True
debug_file = "/home/csetzer/LSST/astrotog_output/debug_log_desgw_alt_sched_rolling.txt"
...
run_dir = "lsst_desgw_kne_alt_sched_rolling_" + datetime.datetime.now().strftime(
    "%d%m%y_%H%M%S"
)
