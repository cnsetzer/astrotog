...
# ----------------------------------------------------------------------
debug = False
debug_file = "/home/csetzer/LSST/astrotog_output/debug_log_desgw_kraken2026.txt"
...
run_dir = "lsst_desgw_kne_kraken2026_" + datetime.datetime.now().strftime(
    "%d%m%y_%H%M%S"
)
base_output_path = "/share/data1/csetzer/lsst_kne_sims_outputs/"
