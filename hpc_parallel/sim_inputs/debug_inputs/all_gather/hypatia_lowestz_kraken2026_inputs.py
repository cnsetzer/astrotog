...
# ----------------------------------------------------------------------
debug = True
debug_file = "/home/csetzer/LSST/astrotog_output/debug_log_020z_allgather_saee.txt"
save_all_output = True
batch_mp_workers = 2
verbose = True
batch_size = 250  # can also be set to 'all'
dithers = True
desc_dithers = True
add_dithers = False
...
t_before = 21.0
t_after = 21.0
z_max = 0.2  # Maximum redshift depth for simulation
...
seds_path = None
cadence_path = "/share/data1/csetzer/lsst_cadences/kraken_2026.db"
dither_path = "/share/data1/csetzer/lsst_cadences/descDithers_kraken_2026.csv"
cadence_ra_col = "_ra"
...
run_dir = "hypatia_debug_saee_nsns_kraken2026_lowerz" + datetime.datetime.now().strftime(
    "%d%m%y_%H%M%S"
)
