...
# ----------------------------------------------------------------------
debug = True
debug_file = "/home/csetzer/LSST/astrotog_output/debug_log_020z_allgather_desgw.txt"
...
run_dir = "hypatia_debug_desgw_kraken2026_lowerz" + datetime.datetime.now().strftime(
    "%d%m%y_%H%M%S"
)
