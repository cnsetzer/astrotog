...
# ----------------------------------------------------------------------
debug = True
debug_file = "/home/csetzer/LSST/astrotog_output/debug_log_0425z.txt"
...
t_before = 21.0
t_after = 21.0
z_max = 0.425  # Maximum redshift depth for simulation
...
run_dir = "hypatia_debug_desgw_kne_kraken2026_lowerz3" + datetime.datetime.now().strftime(
    "%d%m%y_%H%M%S"
)
